    ...
    <div className="mx-auto max-w-3xl pt-4 flex flex-col">
      ...
      <form onSubmit={onSubmit} className="flex flex-col gap-6 mt-6">
        ...
        <button
          type="submit"
          disabled={saving || uploading}
          className="self-end p-3 bg-[var(--color-button-send)] text-white rounded-xl ml-2 cursor-pointer disabled:opacity-60 inline-flex items-center justify-center gap-2 transition"
        >
          <Upload />
